...
โหมดอื่นของแอป (Hand, Gamepad, Servo, Car, Tilt, Voice) ไม่เกี่ยวกับ GDDLink เลยตามที่บอกไว้ด้านบน — แต่ละโหมดมีตัวอย่างโค้ดสั้นๆ ของตัวเองอยู่แล้ว ดูได้ตรงในแอป (หน้า Code/Wiring ของแต่ละโหมด) ไม่ต้องรวมทุกโหมดไว้ในไฟล์เดียว เพราะในการใช้งานจริงแทบไม่มีใครต่อทุกโหมดบนบอร์ดเดียวพร้อมกัน
